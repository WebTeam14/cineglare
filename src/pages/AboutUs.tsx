          ...
          <div className="relative mx-auto max-w-7xl px-6 sm:px-8 lg:px-12">
            ...
            <div className="mt-12 sm:mt-16">
              ...
              <div className="mx-auto max-w-3xl">
                <figure className="relative overflow-hidden rounded-[1.75rem] border border-[#800000]/12 bg-gradient-to-br from-white via-[#fffbfb] to-[#fff5f5] px-8 py-10 shadow-[0_18px_48px_-20px_rgba(0,0,0,0.55)] sm:px-12 sm:py-12">
                  <span
                    aria-hidden
                    className="pointer-events-none absolute left-5 top-3 select-none font-serif text-[6.5rem] leading-none text-[#800000] sm:left-8 sm:top-2 sm:text-[8rem]"
                  >
                    “
                  </span>
                  <blockquote className="relative z-10">
                    <p className="text-center text-lg font-semibold leading-[1.7] tracking-normal text-neutral-900 sm:text-xl sm:leading-[1.75] md:text-2xl md:leading-[1.65]">
