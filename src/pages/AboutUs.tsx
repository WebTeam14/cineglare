    ...
    <div className="min-h-screen overflow-x-hidden bg-black text-white">
      ...
      <main>
        ...
        <section className="relative overflow-hidden bg-[#080808] py-16 sm:py-20 lg:py-24">
          <div aria-hidden className="pointer-events-none absolute -left-24 top-1/4 h-80 w-80 rounded-full bg-[#800000]/20 blur-[120px]" />
          <div aria-hidden className="pointer-events-none absolute -right-20 bottom-0 h-72 w-72 rounded-full bg-[#800000]/12 blur-[100px]" />
          <div className="relative mx-auto max-w-7xl px-6 sm:px-8 lg:px-12">
            <div className="mb-12 flex flex-col gap-6 lg:mb-14 lg:flex-row lg:items-end lg:justify-between">
              <div className="max-w-xl">
                <div className="mb-4 flex items-center gap-3">
                  <span className="h-px w-12 bg-[#800000]" />
                  <span className="text-xs font-semibold uppercase tracking-[0.2em] text-[#800000]">Giving Back</span>
                </div>
            ...
            <div className="mt-12 flex items-center justify-between border-t border-white/10 pt-6">
              <span className="text-xs font-semibold uppercase tracking-[0.2em] text-white/45">Creating impact beyond business</span>
              <ArrowUpRight className="h-5 w-5 text-[#800000]" />
            </div>
          </div>
        </section>
